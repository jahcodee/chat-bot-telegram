    ...
    bot.on('message', async msg => {
        ...
        try {
            ...
            if (text === '/info') {
                ...
                return bot.sendMessage(chatId, `Тебя зовут ${msg.from.first_name} ${msg.from.last_name}, в игре у тебя правильных ответов у тебя ${user.right}, неправильных ответов ${user.wrong}`);
            }
            if (text === '/name') {
